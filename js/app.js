...
var Enemy = function() {
    ...
    var velocities = [50, 70, 100, 120, 150];
    this.x = -100;
    this.y = posY[Math.floor(Math.random() * 3)];
    this.velocity = velocities[Math.floor(Math.random() * 5)];
};
...
Enemy.prototype.checkCollisions = function(){
  ...
  var play1 = {x: player.x, y: player.y, width: 50, height: 50}
  var play2 = {x: this.x, y: this.y, width: 50, height: 50}

  if (play1.x < play2.x + play2.width &&
     play1.x + play1.width > play2.x &&
     play1.y < play2.y + play2.height &&
     play1.height + play1.y > play2.y) {
       player.resetPos();
       player.life -= 1;
  }
}
